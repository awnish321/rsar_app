                ...
                } else
                {
                    try
                    {
                      ...
                      /*  AssetFileDescriptor afd = mParentActivityRef.get().getAssets()
                        ...
                        File SDCardRoot,SDCardRoot1;

                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {

                            SDCardRoot = new File("/storage/emulated/0/Android/data/rsarapp.com.rsarapp/files/Documents/");
                            Log.d("roottt", String.valueOf(SDCardRoot));
                        }else{
